                ...
                <div className="rounded overflow-hidden shadow-lg flex flex-col">
                    ...
                    <div className="relative">
                        <a href="#">
                            <img
                                className="w-full"
                                src="https://img.freepik.com/free-photo/charity-volunteer-giving-helping-hands_53876-121334.jpg?t=st=1743657706~exp=1743661306~hmac=a04d53a8ce4eadc9ad537b4afacbfcb24337cf18c8da53d380487a2eb3cded3b&w=900"
                    ...
                    <div className="px-6 py-4 mb-auto">
                        ...
                        <p className="text-gray-500 text-sm">
                            Discover how small contributions make a big impact in communities worldwide.
                        </p>
                    </div>
                    <div className="px-6 py-3 flex flex-row items-center justify-between bg-gray-100">
                        ...
                        >
                            ...
                            <a href="#_" className="font-medium underline text-purple-700 text-sm">Read More</a>
                    </div>
                </div>
                {/* CARD 2 */}
                <div className="rounded overflow-hidden shadow-lg flex flex-col">
                    ...
                    <div className="relative">
                        <a href="#">
                            <img
                                ...
                                src="https://img.freepik.com/free-photo/donation-community-service-volunteer-support_53876-122818.jpg?t=st=1743657649~exp=1743661249~hmac=58ae707611c1b7e62c0b9d90f532142b9716bf85b24cf073d4c00b6c4f1072a9&w=740"
                            />
                            <div className="hover:bg-transparent transition duration-300 absolute bottom-0 top-0 right-0 left-0 bg-gray-900 opacity-25"></div>
                        </a>
                        <a href="!#">
                    ...
                    <div className="px-6 py-4 mb-auto">
                        ...
                        <p className="text-gray-500 text-sm">
                            Learn how charitable organizations support those in need and create lasting change.
                        </p>
                    </div>
                    <div className="px-6 py-3 flex flex-row items-center justify-between bg-gray-100">
                        <span
                ...
                <div className="rounded overflow-hidden shadow-lg flex flex-col">
                    ...
                    <div className="relative">
                        <a href="#">
                            <img
                                className="w-full"
                                src="https://img.freepik.com/free-photo/piggy-bank-finance-savings-concept_53876-129014.jpg?t=st=1743657744~exp=1743661344~hmac=507081265bcf483077c82e9a3c6c10e1e7935ada49156ef2fe65e19fb1a6cb40&w=996"
                                alt="Sunset in the mountains"
                            />
                            <div className="hover:bg-transparent transition duration-300 absolute bottom-0 top-0 right-0 left-0 bg-gray-900 opacity-25"></div>
                        </a>
                    ...
                    <div className="px-6 py-4 mb-auto">
                        <a
                            ...
                            className="font-medium text-lg inline-block hover:text-indigo-600 transition duration-500 ease-in-out inline-block mb-2"
                        >
                            A Guide to Meaningful Giving
                        </a>
                        <p className="text-gray-500 text-sm">
                            Explore how your generosity can bring hope and transformation to countless lives.
                        </p>
                    </div>
                    <div className="px-6 py-3 flex flex-row items-center justify-between bg-gray-100">
                        <span
