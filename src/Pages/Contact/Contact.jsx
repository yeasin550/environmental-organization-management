...
const Contact = () => {
    return (
        <div className="w-11/12 mx-auto ">
            <div
                className="h-80 bg-gray-800 flex items-center justify-center"
            >
                <div className="text-center">
                    <div className="max-w-md">
                        <h1 className="mb-5 text-5xl font-bold text-white">Contact Us</h1>
                        <p className="text-gray-300">“ CONTACT US WHENEVER YOU NEED ”</p>
                    </div>
                </div>
            </div>
            ...
            <div className="text-center my-12 space-y-5 w-10/12 mx-auto">
                ...
                <p>
                    Before making a donation, it's important to consider how your contribution will make a difference. Understand the cause, the organization’s transparency, and the impact your donation will have. Research reviews and testimonials to ensure the organization aligns with your values. Feel free to contact us anytime with any questions or if you need more information before contributing, ensuring a meaningful and confident donation experience.
                </p>
            </div>
            <form className="">
                <textarea
